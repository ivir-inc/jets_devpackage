...
public class GetPhysiologyListAction extends Action {
    private ControlWebClient controlWebClient;
    private DevPackageMainPage gui;

    public GetPhysiologyListAction(ControlWebClient controlWebClient, DevPackageMainPage gui){
    ...
    public void perform(Component component) {
        try {
            QueryResponse response = controlWebClient.queryVitalSignsList().get();
