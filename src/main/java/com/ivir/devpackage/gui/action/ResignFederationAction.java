...
public class ResignFederationAction extends Action {
    private ControlWebClient controlWebClient;
    private DevPackageMainPage gui;

    public ResignFederationAction(ControlWebClient controlWebClient, DevPackageMainPage gui){
    ...
    public void perform(Component component) {
        try {
            QueryResponse response = controlWebClient.mutateDisconnect().get();
