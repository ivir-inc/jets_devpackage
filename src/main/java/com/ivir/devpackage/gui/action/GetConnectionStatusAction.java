...
public class GetConnectionStatusAction extends Action {
    private ControlWebClient controlWebClient;
    private DevPackageMainPage gui;

    public GetConnectionStatusAction(ControlWebClient controlWebClient, DevPackageMainPage gui){
    ...
    public void perform(Component component) {
        try {
            QueryResponse response = controlWebClient.getConnectionStatus().get();
