...
public class GetFederateListAction extends Action {
    private ControlWebClient controlWebClient;
    private DevPackageMainPage gui;

    public GetFederateListAction(ControlWebClient controlWebClient, DevPackageMainPage gui){
    ...
    public void perform(Component component) {
        try {
            QueryResponse response = controlWebClient.queryFederateList().get();
